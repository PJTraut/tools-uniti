...
| [ADR-0006](ADR-0006-executable-health-recovery-boundary.md) | accepted | Make native bundles the future public product entry with two-level health, consent-based offline repair, Safe Session, and no supported public CLI. |
