...
| Verified a16 implementation checkpoint | `7d8866a` — final editor interactions and glyph-boundary selection |
...
- Find/Replace is a floating modeless utility with independent keyboard/mouse zoom, geometry, separate 50-step Find and Replace histories, focus-owned editing commands, and Hidden/Bottom/Right report placement;
